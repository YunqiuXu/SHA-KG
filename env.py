...
GraphInfo = collections.namedtuple('GraphInfo','objs, ob_rep, act_rep, graph_state, graph_state_rep, graph_state_1_connectivity, graph_state_rep_1_connectivity, graph_state_2_roomitem, graph_state_rep_2_roomitem, graph_state_3_youritem, graph_state_rep_3_youritem, graph_state_4_otherroom, graph_state_rep_4_otherroom, graph_state_5_mask, graph_state_rep_5_mask, admissible_actions, admissible_actions_rep')
...
class KGA2CEnv:
    ...
    def reset(self):
        ...
        self.state_rep = StateAction(self.spm_model, 
                                    self.vocab, 
                                    self.vocab_rev,
                                    self.tsv_file, 
                                    self.max_word_len)
    ...
    def step(self, action):
        ...
        if done:
            graph_info = GraphInfo(
                            ...
                            graph_state_1_connectivity=self.state_rep.graph_state_1_connectivity, 
                            graph_state_rep_1_connectivity=self.state_rep.graph_state_rep_1_connectivity,
                            graph_state_2_roomitem=self.state_rep.graph_state_2_roomitem, 
                            graph_state_rep_2_roomitem=self.state_rep.graph_state_rep_2_roomitem,
                            graph_state_3_youritem=self.state_rep.graph_state_3_youritem, 
                            graph_state_rep_3_youritem=self.state_rep.graph_state_rep_3_youritem,
                            graph_state_4_otherroom=self.state_rep.graph_state_4_otherroom, 
                            graph_state_rep_4_otherroom=self.state_rep.graph_state_rep_4_otherroom,
